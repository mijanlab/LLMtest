...
[![PyPI Version](https://img.shields.io/badge/pypi-v1.0.6-09090b?style=flat-square&logo=pypi&logoColor=white&labelColor=27272a)](https://github.com/mijanlab/LLMtest)
...
```text
  ⚡ LLM Speed & Latency Benchmark (v1.0.6)
  ═══════════════════════════════════════════════════════════════════════════════════
